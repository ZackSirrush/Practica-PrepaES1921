...
<body>  
    ...
    <section class="form-register">
        <center>
            <p>Por favor, ingrese una matrícula a consultar:</p>
            <form action="" method="post">
                <label class="usrlbl" for="Matrícula">Consulta por matrícula</label>
    ...
    if(isset($_POST['enviar'])){     
        ...
        $sql->execute(array('Matricula'=>$busqueda));   //Ejecuta sentencia
        ...
        $sentencia->execute(array('Matricula'=>$busqueda));   //Ejecuta sentencia
        $asignaturas=$sentencia->fetchAll(PDO::FETCH_ASSOC);
    } else {
        echo "<h3> No se ha seleccionado ningún alumno</h3>";
        echo "<h3> Ingrese una matrícula para obtener los valores</h3>";
    }
    ?>
            ...
            <div class="col-12">
                ...
                <div class="card-body p-0">
                    ...
                    <table class="table table-striped mb-0">
                        ...
                        <tbody>
                        <?php
                            foreach($asignaturas as $asignatura){ //Obtiene los datos de las asignaturas que correspondan con la matrícula indicada por Servicios escolares
                            $id=$asignatura['id'];
                        ...
                        <tr>
                            ...
                            <?php echo '<td><a href="editarSE.php?id='.$id.'">Editar</a>&nbsp;<a href="eliminarSE.php?id='.$id.'">Eliminar</a></td>';?> <!-- Recibe el id del elemento seleccionado en la tabla -->
                        </tr>
                        <?php } ?> 
