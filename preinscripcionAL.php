...
<html lang="en">
  ...
  <header>
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark indigo">
        ...
        <?php
            if($count==1){
                echo "<h3> Alumno: $matricula, Nombre: $nombre $ap $am </h3>"; //Muestra la matrícula y el nombre del alumno 
            } else {
        ...
        ?>    
                <section class="form-register">
                    ...
                    <h1 id="titulo">Preinscribir asignaturas</h1>
                        ...
                        <form class="p-3 mt-3" action="preinscribirAsignatura.php" method="post"> <!-- Matrícula -->
                            <div class="form-field d-flex align-items-center">
                                <input type="text" id="matricula" name="matricula" value="<?php echo $row['matricula']; ?>" title="Ingresa solo números" minlength="4" maxlength="4" placeholder="Matrícula" readonly pattern="[0-9]+"/>
                            </div>
                            ...
                            <div class="form-field d-flex align-items-center"> <!-- Grupo -->
                                <input type="text" id="grupo" name="grupo" value="0" title="Ingresa el grupo al que pertenece el alumno" minlength="2" maxlength="20" placeholder="Grupo" readonly pattern="[0-9]+"/>
                            </div>
                            <div class="form-field d-flex align-items-center"> <!-- Profesor -->
                                <input type="text" id="profesor" name="profesor" value="Por asignar" title="Ingresa solo letras y espacios (puede llevar acentos)" minlength="2" maxlength="90" placeholder="Profesor asignado" readonly pattern="^[a-zA-ZÀ-ÿ\s]{2,30}$"/>
                            </div>
